...
- [Agent 基础与工具]({{ site.baseurl }}/docs/interview/ai-agent/runtime/)：Agent 定义、ReAct、Function Calling、MCP、Skill 与工具失败；
- [Agent Context 与记忆]({{ site.baseurl }}/docs/interview/ai-agent/context-memory/)：任务状态、会话历史、短期与长期记忆、Context 组装与去噪；
...
- [Agent 质量、安全与生产运行]({{ site.baseurl }}/docs/interview/ai-agent/quality-production/)：Harness、Prompt Injection、幻觉、评测、优化、缓存与进度事件。
...
### [什么是 ReAct？Agent 怎样避免无限循环？]({{ site.baseurl }}/docs/interview/ai-agent/runtime/#react-loop)
{: #react-loop }
...
### [一个标准 RAG 系统包含哪些步骤？]({{ site.baseurl }}/docs/interview/ai-agent/rag/#rag-pipeline)
{: #rag-pipeline }
...
### [Chunk 大小怎样选择？]({{ site.baseurl }}/docs/interview/ai-agent/rag/#rag-chunk-size)
{: #rag-chunk-size }

### [父子索引什么时候值得使用？]({{ site.baseurl }}/docs/interview/ai-agent/rag/#rag-parent-child-index)
{: #rag-parent-child-index }

### [为什么 RAG 常结合关键词检索和 Rerank？]({{ site.baseurl }}/docs/interview/ai-agent/rag/#hybrid-search-rerank)
{: #hybrid-search-rerank }

### [Rerank 后保留多少内容？怎样处理 Context 预算？]({{ site.baseurl }}/docs/interview/ai-agent/rag/#rag-rerank-context-budget)
{: #rag-rerank-context-budget }

### [RAG 系统怎样评测？评测集包含什么？]({{ site.baseurl }}/docs/interview/ai-agent/rag/#rag-evaluation-dataset)
{: #rag-evaluation-dataset }

### [RAG 优化应从哪里开始？]({{ site.baseurl }}/docs/interview/ai-agent/rag/#rag-optimization)
{: #rag-optimization }
