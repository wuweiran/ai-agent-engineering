...
相关内容：[Token、Attention 与生成](../../llm/model-inference/)。
...
相关内容：[Agent 任务与运行循环](../../ai-agent/agent-runtime/)、[Agent 执行与终止](../../ai-agent/agent-design/execution-control/)。
...
相关内容：[Agent 工具](../../ai-agent/agent-design/tools/)。
...
相关内容：[Prompt 与结构化输出](../../llm/prompt-structured-output/)。
...
相关内容：[Agent 状态与记忆](../../ai-agent/agent-design/state-memory/)。
...
相关内容：[Agent 状态与记忆](../../ai-agent/agent-design/state-memory/)、[Claude Code 长会话](../../ai-agent/claude-code/session-compaction/)。
...
相关内容：[Agent Planning](../../ai-agent/agent-design/planning/)。
...
相关内容：[多 Agent 协作](../../ai-agent/agent-design/multi-agent/)。
...
相关内容：[Agent 评测](../../ai-agent/agent-quality/evaluation/)。
...
相关内容：[流式生成与任务事件](../../backend/llm-backend/streaming-generation/)。
